...
const depcheck = require('../packages/core/dist').default;
const { resolveShortPath } = require('./utils');

const {
  full: importListParser,
  lite: importListParserLite,
} = require('./fake_parsers/importList');

const exceptionParser = require('./fake_parsers/exception');
const { multipleParserA, multipleParserB } = require('./fake_parsers/multiple');

const exceptionDetector = require('./fake_detectors/exception');
const dependDetector = require('./fake_detectors/dependCallExpression');
