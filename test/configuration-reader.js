...
const ConfigurationParsingException = require('../packages/cli/dist/utils/exceptions/configuration-parsing-exception');
...
describe('configuration-reader', () => {
  ...
  before(() => {
    configurationReaderModule = proxyquire(
      '../packages/cli/dist/utils/configuration-reader',
      {
        cosmiconfig: {
          cosmiconfig: () => {
            return {
